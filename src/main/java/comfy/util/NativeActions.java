...
import static comfy.util.Direction.UP;
...
public class NativeActions {
    ...
    public static void hideKeyboard() {
        switch (PLATFORM) {
            case ANDROID -> ((AndroidDriver) getWebDriver()).hideKeyboard();
            case IOS -> ((IOSDriver) getWebDriver()).hideKeyboard();
        }
    }
    ...
    public static boolean isElementSticky(SelenideElement element, Direction direction, RelativePosition position) {
        ...
        NativeActions.swipeFromScreenCenter(direction);
